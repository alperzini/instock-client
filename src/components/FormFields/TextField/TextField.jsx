...
function TextField(props) {
    //type = text | tel | email
    const { label, name, id, type, placeholder, value, onChange, error, isError } = props;
    ...
    return (
        <div className="text-field__wrapper">
            ...
            <input className={`text-field__text-input ${isError ? "text-field__text-input--error-border" : ""}`}
                type={type} id={id} name={name} placeholder={placeholder} value={value} onChange={onChange} />
